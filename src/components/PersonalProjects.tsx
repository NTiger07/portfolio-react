...
const projects: Project[] = [
  ...
  },
  {
    ...
    desc: <span>A full-stack web app built with {b('React')}, {b('TypeScript')}, and {b('MongoDB')} for scheduling and managing hospital stays, with patient and doctor dashboards, appointment slot management, and real-time status updates. Deployed on {b('Render')}.</span>,
  ...
  },
  {
    ...
    links: [
      { label: 'View Repo', href: 'https://github.com/NTiger07/Recipe-App-Src' },
      { label: 'Live Site', href: 'https://vgnup.netlify.app/' },
    ],
    image: '/recipe.png',
  },
]
